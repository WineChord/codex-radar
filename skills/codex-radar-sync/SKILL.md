...
1. Fetch the homepage and all four public endpoints. Note the retrieval date, root keys, changed field types, new visible site sections, and any new public links or APIs.
...
- `model-iq.json.latest.iq_score` can be decimal, for example `62.5`; do not decode it as an integer.
